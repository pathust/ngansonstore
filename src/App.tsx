...
const MainLayout: React.FC = () => {
  ...
  if (!isAuthenticated) {
    return (
      <div className="app-theme-scope min-h-[100dvh] w-full overflow-y-auto font-sans antialiased relative">
        <LoginScreen />
        <ToastContainer />
      </div>
    );
  ...
  if (isMobileScreen) {
    return (
      <div className="app-theme-scope h-screen w-screen overflow-hidden font-sans antialiased relative">
        <React.Suspense fallback={<div className="h-full w-full flex items-center justify-center text-sm text-slate-500">Đang tải giao diện mobile...</div>}>
          <MobileAppContainer
  ...
  return (
    <div className="app-theme-scope flex flex-col h-screen w-screen overflow-hidden font-sans antialiased relative">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <footer className="h-7 bg-white border-t border-slate-200 px-4 md:px-6 flex items-center justify-between text-[10px] text-slate-500 shrink-0 select-none">
          <div className="flex items-center gap-3">
            ...
            <span className="hidden sm:inline text-slate-300">|</span>
            <span className="hidden sm:inline">In K80: qua hộp thoại in của thiết bị</span>
          </div>
          <div className="flex items-center gap-3">
            <button
